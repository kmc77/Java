...
class Rectangle implements java.io.Serializable{
	...
	/* 실행방법
	 1. 아래 getArea 메서드의 주석을 달고 실행한 경우에는 에러 없음
	 ObfectOutputExacmple.java를 실행
	 ObfectInputExacmple.java 실행
	 
	 2. 아래 메서드의 주석을 푼 후 - 에러 발생
	 ObfectInputExacmple.java를 실행
	 ...
	 자동으로 부여되는데 직렬화 가능 클래스의 내용이 그래도이면 같은 번호가 부여되고
