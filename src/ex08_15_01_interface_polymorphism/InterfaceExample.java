...
class InterfaceExample {
	...
	public static void main(String[] args) {
		...
		arr0 = new SeparateVolume("882o", "푸코의 진자", "에코");
		...
		checkOut(arr0, "홍길동", "2023-05-17");
		checkOut(arr1, "홍길동", "2023-05-17");
		checkOut(arr2, "홍길동", "2023-05-17");
	...
	static void checkOut(Lendable arr, String name, String num) {
		arr.checkOut(name, num);
